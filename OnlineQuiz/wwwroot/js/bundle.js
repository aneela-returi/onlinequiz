...
var _testselection = __webpack_require__(82);

var _testselection2 = _interopRequireDefault(_testselection);

var _quiz = __webpack_require__(83);

var _quiz2 = _interopRequireDefault(_quiz);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Q = function Q(_ref) {
    var match = _ref.match;

    return _react2.default.createElement(_quiz2.default, { test: match.params.test });
};
...
var App = function App() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            null,
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _testselection2.default }),
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/quiz.html', component: _testselection2.default }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/starttest/:test', component: Q })
        )
    );
};
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement('input', { type: 'radio', 'class': 'form-check-input', name: 'optradio', value: 'csharp', checked: this.state.selectedTest == 'csharp', onChange: this.handleChange }),
                                'CSharp'
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'label',
                                { className: 'form-check-label' },
                                _react2.default.createElement('input', { type: 'radio', 'class': 'form-check-input', name: 'optradio', value: 'html', checked: this.state.selectedTest == 'html', onChange: this.handleChange }),
                                'HTML'
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'label',
                                { className: 'form-check-label' },
                                _react2.default.createElement('input', { type: 'radio', 'class': 'form-check-input', name: 'optradio', value: 'js', checked: this.state.selectedTest == 'js', onChange: this.handleChange }),
                                'JavaScript'
                            )
                        ),
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { type: 'submit', disabled: !this.state.selectedTest, className: 'btn btn-default btn-md', onClick: this.handleClick },
                                    'Start'
                                )
                            )
                        )
...
exports.default = (0, _reactRouterDom.withRouter)(TestSelection);
...
var Quiz = function (_React$Component) {
    ...
    function Quiz(props) {
        ...
        _this.state = { quizId: -1, question: null, answer: -1, questionNum: 0, isLastQuestion: false, endOfTest: false };
        _this.nextClick = _this.nextClick.bind(_this);
        _this.handleAnswerOption = _this.handleAnswerOption.bind(_this);
        _this.finishClick = _this.finishClick.bind(_this);
    ...
    _createClass(Quiz, [{
        ...
        value: function componentDidMount() {
            ...
            _axios2.default.get('/api/quiz/start', { params: { exam: this.props.test } }).then(function (res) {
                console.log(res.data);
                _this2.setState({ quizId: res.data });
                _this2.loadNextQuestion();
        ...
        value: function loadNextQuestion() {
            ...
            if (!this.state.isLastQuestion) {
                _axios2.default.post('/api/quiz/next', "quizNumber=" + this.state.quizId).then(function (nextResult) {
                    console.log(nextResult.data.question);
                    _this3.state.question = nextResult.data.question;
                    _this3.state.isLastQuestion = nextResult.data.isLastQuestion;
                    _this3.state.questionNum = nextResult.data.qNo;
        ...
        value: function nextClick(e) {
            ...
            _axios2.default.post('/api/quiz/answer', { quizId: this.state.quizId, questionId: q.questionId, answer: this.state.answer }).then(function (answerResult) {
                console.log(answerResult.data);

                //clear answer
                _this4.state.answer = -1;
                //this.state.endOfTest = this.state.isLastQuestion;
                _this4.loadNextQuestion();
            }).catch(function (err) {
                console.log(err);
            });
        }
    }, {
        key: 'handleAnswerOption',
        value: function handleAnswerOption(e) {
            this.state.answer = e.target.value;
            this.setState(this.state);
        }
    }, {
        key: 'finishClick',
        value: function finishClick(e) {
            var _this5 = this;
        ...
        value: function getResults() {
            ...
            _axios2.default.post('/api/quiz/result', "quizNumber=" + this.state.quizId).then(function (results) {
                console.log(results.data);
                _this6.state['results'] = results.data;
        ...
        value: function render() {
            ...
            if (this.state.question != null && this.state.question != undefined) {
                ...
                options = this.state.question.options.map(function (o, index) {
                    return _react2.default.createElement(
                        'div',
                        { 'class': 'radio' },
                        _react2.default.createElement(
                            'label',
                            null,
                            _react2.default.createElement('input', { type: 'radio', name: 'answer', value: index, checked: _this7.state.answer == index, onChange: handleAnswer }),
                            o
                        )
                    );
                });
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    !this.state.endOfTest ? _react2.default.createElement(
                        'div',
                        null,
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-md-4' },
                        !this.state.isLastQuestion && _react2.default.createElement('input', { type: 'button', onClick: this.nextClick, 'class': 'btn btn-default', value: 'Next' }),
                        !hideFinishBtn && _react2.default.createElement('input', { type: 'button', onClick: this.finishClick, 'class': 'btn btn-default', value: 'Finish' })
                    ),
                    _react2.default.createElement(
                        'div',
                        null,
