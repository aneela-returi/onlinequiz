            ...
            <div>
                <form className="form-horizontal">
                    ...
                    <div className='col-md-4'>
                        {!this.state.isLastQuestion && <input type='button' onClick={this.nextClick} className="btn btn-default" value="Next" />}
                        {!hideFinishBtn && <input type='button' onClick={this.finishClick} className="btn btn-default" value="Finish" />}
                    </div>
                    <div>
                        {results}
                    </div>
